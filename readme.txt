...
* Campos podem ser organizados em etapas dentro de “Seus Dados”, com validação antes de avançar.
...
= 1.16.0 =
* Em checkout com etapas, revela pagamento e finalizar pedido somente após “Ir para pagamento”.

= 1.15.9 =
* Move os controles das etapas para o fim dos dados do cliente.

= 1.15.8 =
* Ao finalizar, abre a etapa do primeiro campo inválido, foca-o e impede o envio até a correção.

= 1.15.7 =
* Corrige a alternância visual dos campos entre as etapas de “Seus Dados”.
...
* Separa requisitos específicos do método e requisitos gerais do WooCommerce no modal, com seção recolhível para os campos gerais.

= 1.13.47 =
* Adiciona diagnóstico de requisitos de campos por plugin de gateway no editor do checkout, com seleção individual por plugin e suporte a múltiplos métodos.
...
= 1.13.43 =
* Corrige a máscara de telefone para suportar dinamicamente tanto telefones fixos (10 dígitos) quanto celulares (11 dígitos).
