...
$bump_enabled      = 'yes' === ( class_exists( 'GVN\Checkout\Settings\SettingsRepository' ) ? \GVN\Checkout\Settings\SettingsRepository::get( 'order_bump_enabled', 'no' ) : get_option( 'gvn_checkout_order_bump_enabled', 'no' ) ) && 'yes' !== \GVN\Checkout\Settings\SettingsRepository::get( 'single_product_checkout' );
...
<div class="gvn-checkout" id="gvn-checkout">
    ...
    <form name="checkout" method="post" class="checkout woocommerce-checkout gvn-form" action="<?php echo esc_url( function_exists( 'wc_get_checkout_url' ) ? wc_get_checkout_url() : '' ); ?>" enctype="multipart/form-data">
        ...
        <div class="gvn-grid">
            ...
            <div class="gvn-col-main-payment" data-gvn-payment-panel>
